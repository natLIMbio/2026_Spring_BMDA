...
options(timeout = 3600)  # extend timeout for large file
download.file(
  ...
  destfile = "C:/Users/unowh/hg38.fna.gz",
  mode = "wb"
)

# Decompress
require(R.utils)
R.utils::gunzip("C:/Users/unowh/hg38.fna.gz", destname = "C:/Users/unowh/hg38.fa", remove = FALSE)
```
```{r}
library(Rsubread)

# Step 1: Build index (do once, takes 30-60 min)
buildindex(
  basename  = "C:/Users/unowh/hg38_index",
  reference = "C:/Users/unowh/hg38.fa"
)
```
...
# Set output BAM file paths
bam_files <- file.path(
  "C:/hiv-tb-data",
  sub("\\.fastq$", ".bam", basename(fastq_files))
)

# Run alignment
align(
  index       = "C:/Users/unowh/hg38_index",
...
```{r}
# Step 3: featureCounts (Q2)
# Download GTF annotation first
download.file(
  url = "https://ftp.ebi.ac.uk/pub/databases/gencode/Gencode_human/release_44/gencode.v44.annotation.gtf.gz",
  destfile = "C:/Users/unowh/gencode.v44.gtf.gz",
  mode = "wb"
)
R.utils::gunzip("C:/Users/unowh/gencode.v44.gtf.gz", destname = "C:/Users/unowh/gencode.v44.gtf", remove = FALSE)

# Run featureCounts
fc <- featureCounts(
  files                  = bam_files,
  annot.ext              = "C:/Users/unowh/gencode.v44.gtf",
  isGTFAnnotationFile    = TRUE,
  nthreads               = 4,
  isPairedEnd            = FALSE
)

# Save output for Q2 upload
write.table(
  fc$counts,
  file      = "C:/Users/unowh/NL_featureCounts.txt",
  sep       = "\t",
  quote     = FALSE,
  col.names = NA
)
